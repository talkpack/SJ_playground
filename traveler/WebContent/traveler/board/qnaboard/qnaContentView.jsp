      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header">
            	<i class="fa fa-laptop"></i>상세 내용
            </h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="fa fa-file-text-o"></i>Q&A</li>
            </ol>
          </div>
        </div>
        <form enctype="multipart/form-data" class="contentForm" >
				<table class="table">
					...
					<tr>
						<th class="info" style="text-align:center">카테고리</th>
					...
					<c:if test="${article.depth == 0 }">
						<tr>
							...
							<th colspan="3"><a
								href="${pageContext.request.contextPath }/qnaBoard/qnaFileDownloadAction.b?filename=${article.filename}">${article.filename }</a></th>
						</tr>
					</c:if>
					<tr>
						<td colspan="4" class="text-center"><input type="button"
							class="btn btn-success" value="답글쓰기"
							onClick="location.href='${pageContext.request.contextPath}/qnaBoard/qnaWriteForm.b?num=${article.num}&ref=${article.ref}&step=${article.step}&depth=${article.depth}'">
							<input type="button" class="btn btn-warning" value="수정"
							onclick="document.location.href='${pageContext.request.contextPath}/qnaBoard/qnaModifyForm.b?num=${article.num}&pageNum=${pageNum}'">
							<input type="button" class="btn btn-danger" value="삭제"
							onclick="document.location.href='${pageContext.request.contextPath}/qnaBoard/qnaDeleteForm.b?num=${article.num}&pageNum=${pageNum}'">
