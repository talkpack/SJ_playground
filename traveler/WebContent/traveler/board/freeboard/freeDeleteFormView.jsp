...
function deleteCheck(){ 
	if (confirm("삭제 하시겠습니까?")){ 
		if(document.deleteForm.writepwd.value == ""){
			alert("비밀번호를 입력하세요.");
			document.deleteForm.writepwd.focus();
			return false;
		}
		location.href="${pageContext.request.contextPath }/freeBoard/freeDeleteResult.b?pageNum=${pageNum}";
	}else{ 
		alert("취소 되었습니다."); 
		return false; 
	} 
...
<body>
	...
	<section id="main-content">
		<section class="wrapper">
			...
			<form name="deleteForm" action="${pageContext.request.contextPath }/freeBoard/freeDeleteResult.b?pageNum=${pageNum}" onsubmit="return deleteCheck()" method="post">
				<div class="table table-responsive">
					<table class="table">
						<tr>
							<th class="danger" style="text-align:center">글번호</th>
							<th>${article.num }</th>
							<th class="danger" style="text-align:center">조회수</th>
							<th>${article.readcount }</th>
						</tr>
						<tr>
							<th class="danger" style="text-align:center">작성자</th>
							<th>${article.writer }</th>
							<th class="danger" style="text-align:center">작성일</th>
							<th>${article.regdate }</th>
						</tr>
						<tr>
							<th class="danger" style="text-align:center">제목</th>
